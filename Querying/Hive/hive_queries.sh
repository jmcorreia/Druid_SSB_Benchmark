...
echo -e '\nQUERY1.1-STARTING'
echo '----------------------------------------------------------------------------------------------------------------' > $path/results_hive_druid_$1.txt
echo "						Benchmark Results $1"																		>> $path/results_hive_druid_$1.txt
echo '----------------------------------------------------------------------------------------------------------------' >> $path/results_hive_druid_$1.txt
echo -e "\n+++++++++++++++++++++++++++++++++++++++++ QUERY-1.1 ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++" >> $path/results_hive_druid_$1.txt
...
do 
    ...
    echo "----------------------------------------------------------------------------------------------------------------">>$path/results_hive_druid_$1.txt
	echo "--------------------------------------------RUN-"$i"---------------------------------------------------------------">>$path/results_hive_druid_$1.txt
 	{ time beeline -u "jdbc:hive2://$host:$port/;serviceDiscoveryMode=zooKeeper;zooKeeperNamespace=hiveserver2-hive2" -e "\"$q1_1\""; } &>> $path/results_hive_druid_$1.txt
	echo "-------------------------------------------FIM-RUN-"$i"------------------------------------------------------------">>$path/results_hive_druid_$1.txt

done

echo 'QUERY1.1-DONE'
echo -e '\nQUERY1.2-STARTING'
echo -e "\n\n+++++++++++++++++++++++++++++++++++++++++ QUERY-1.2 ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++">>$path/results_hive_druid_$1.txt
...
do 
    ...
    echo "----------------------------------------------------------------------------------------------------------------">>$path/results_hive_druid_$1.txt
	echo "--------------------------------------------RUN-"$i"---------------------------------------------------------------">>$path/results_hive_druid_$1.txt
 	{ time beeline -u "jdbc:hive2://$host:$port/;serviceDiscoveryMode=zooKeeper;zooKeeperNamespace=hiveserver2-hive2" -e "\"$q1_2\""; } &>> $path/results_hive_druid_$1.txt
	echo "-------------------------------------------FIM-RUN-"$i"------------------------------------------------------------">>$path/results_hive_druid_$1.txt
...
echo 'QUERY1.2-DONE'
echo -e '\nQUERY1.3-STARTING'
echo -e "\n\n+++++++++++++++++++++++++++++++++++++++++ QUERY-1.3 ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++">>$path/results_hive_druid_$1.txt
...
do 
    ...
    echo "----------------------------------------------------------------------------------------------------------------">>$path/results_hive_druid_$1.txt
	echo "--------------------------------------------RUN-"$i"---------------------------------------------------------------">>$path/results_hive_druid_$1.txt
 	{ time beeline -u "jdbc:hive2://$host:$port/;serviceDiscoveryMode=zooKeeper;zooKeeperNamespace=hiveserver2-hive2" -e "\"$q1_3\""; } &>> $path/results_hive_druid_$1.txt
	echo "-------------------------------------------FIM-RUN-"$i"------------------------------------------------------------">>$path/results_hive_druid_$1.txt
...
echo 'QUERY1.3-DONE'
echo -e '\nQUERY2.1-STARTING'
echo -e "\n\n+++++++++++++++++++++++++++++++++++++++++ QUERY-2.1 ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++">>$path/results_hive_druid_$1.txt
...
do 
    ...
    echo "----------------------------------------------------------------------------------------------------------------">>$path/results_hive_druid_$1.txt
	echo "--------------------------------------------RUN-"$i"---------------------------------------------------------------">>$path/results_hive_druid_$1.txt
 	{ time beeline -u "jdbc:hive2://$host:$port/;serviceDiscoveryMode=zooKeeper;zooKeeperNamespace=hiveserver2-hive2" -e "\"$q2_1\""; } &>> $path/results_hive_druid_$1.txt
	echo "-------------------------------------------FIM-RUN-"$i"------------------------------------------------------------">>$path/results_hive_druid_$1.txt
...
echo 'QUERY2.1-DONE'
echo -e '\nQUERY2.2-STARTING'
echo -e "\n\n+++++++++++++++++++++++++++++++++++++++++ QUERY-2.2 ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++">>$path/results_hive_druid_$1.txt
...
do 
    ...
    echo "----------------------------------------------------------------------------------------------------------------">>$path/results_hive_druid_$1.txt
	echo "--------------------------------------------RUN-"$i"---------------------------------------------------------------">>$path/results_hive_druid_$1.txt
 	{ time beeline -u "jdbc:hive2://$host:$port/;serviceDiscoveryMode=zooKeeper;zooKeeperNamespace=hiveserver2-hive2" -e "\"$q2_2\""; } &>> $path/results_hive_druid_$1.txt
	echo "-------------------------------------------FIM-RUN-"$i"------------------------------------------------------------">>$path/results_hive_druid_$1.txt
...
echo 'QUERY2.2-DONE'
echo -e '\nQUERY2.3-STARTING'
echo -e "\n\n+++++++++++++++++++++++++++++++++++++++++ QUERY-2.3 ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++">>$path/results_hive_druid_$1.txt
...
do 
    ...
    echo "----------------------------------------------------------------------------------------------------------------">>$path/results_hive_druid_$1.txt
	echo "--------------------------------------------RUN-"$i"---------------------------------------------------------------">>$path/results_hive_druid_$1.txt
 	{ time beeline -u "jdbc:hive2://$host:$port/;serviceDiscoveryMode=zooKeeper;zooKeeperNamespace=hiveserver2-hive2" -e "\"$q2_3\""; } &>> $path/results_hive_druid_$1.txt
	echo "-------------------------------------------FIM-RUN-"$i"------------------------------------------------------------">>$path/results_hive_druid_$1.txt
...
echo 'QUERY2.3-DONE'
echo -e '\nQUERY3.1-STARTING'
echo -e "\n\n+++++++++++++++++++++++++++++++++++++++++ QUERY-3.1 ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++">>$path/results_hive_druid_$1.txt
...
do 
    ...
    echo "----------------------------------------------------------------------------------------------------------------">>$path/results_hive_druid_$1.txt
	echo "--------------------------------------------RUN-"$i"---------------------------------------------------------------">>$path/results_hive_druid_$1.txt
 	{ time beeline -u "jdbc:hive2://$host:$port/;serviceDiscoveryMode=zooKeeper;zooKeeperNamespace=hiveserver2-hive2" -e "\"$q3_1\""; } &>> $path/results_hive_druid_$1.txt
	echo "-------------------------------------------FIM-RUN-"$i"------------------------------------------------------------">>$path/results_hive_druid_$1.txt
...
echo 'QUERY3.1-DONE'
echo -e '\nQUERY3.2-STARTING'
echo -e "\n\n+++++++++++++++++++++++++++++++++++++++++ QUERY-3.2 ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++">>$path/results_hive_druid_$1.txt
...
do 
    ...
    echo "----------------------------------------------------------------------------------------------------------------">>$path/results_hive_druid_$1.txt
	echo "--------------------------------------------RUN-"$i"---------------------------------------------------------------">>$path/results_hive_druid_$1.txt
 	{ time beeline -u "jdbc:hive2://$host:$port/;serviceDiscoveryMode=zooKeeper;zooKeeperNamespace=hiveserver2-hive2" -e "\"$q3_2\""; } &>> $path/results_hive_druid_$1.txt
	echo "-------------------------------------------FIM-RUN-"$i"------------------------------------------------------------">>$path/results_hive_druid_$1.txt
...
echo 'QUERY3.2-DONE'
echo -e '\nQUERY3.3-STARTING'
echo -e "\n\n+++++++++++++++++++++++++++++++++++++++++ QUERY-3.3 ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++">>$path/results_hive_druid_$1.txt
...
do 
    ...
    echo "----------------------------------------------------------------------------------------------------------------">>$path/results_hive_druid_$1.txt
	echo "--------------------------------------------RUN-"$i"---------------------------------------------------------------">>$path/results_hive_druid_$1.txt
 	{ time beeline -u "jdbc:hive2://$host:$port/;serviceDiscoveryMode=zooKeeper;zooKeeperNamespace=hiveserver2-hive2" -e "\"$q3_3\""; } &>> $path/results_hive_druid_$1.txt
	echo "-------------------------------------------FIM-RUN-"$i"------------------------------------------------------------">>$path/results_hive_druid_$1.txt
...
echo 'QUERY3.3-DONE'
echo -e '\nQUERY3.4-STARTING'
echo -e "\n\n+++++++++++++++++++++++++++++++++++++++++ QUERY-3.4 ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++">>$path/results_hive_druid_$1.txt
...
do 
    ...
    echo "----------------------------------------------------------------------------------------------------------------">>$path/results_hive_druid_$1.txt
	echo "--------------------------------------------RUN-"$i"---------------------------------------------------------------">>$path/results_hive_druid_$1.txt
 	{ time beeline -u "jdbc:hive2://$host:$port/;serviceDiscoveryMode=zooKeeper;zooKeeperNamespace=hiveserver2-hive2" -e "\"$q3_4\""; } &>> $path/results_hive_druid_$1.txt
	echo "-------------------------------------------FIM-RUN-"$i"------------------------------------------------------------">>$path/results_hive_druid_$1.txt
...
echo 'QUERY3.4-DONE'
echo -e '\nQUERY4.1-STARTING'
echo -e "\n\n+++++++++++++++++++++++++++++++++++++++++ QUERY-4.1 ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++">>$path/results_hive_druid_$1.txt
...
do 
    ...
    echo "----------------------------------------------------------------------------------------------------------------">>$path/results_hive_druid_$1.txt
	echo "--------------------------------------------RUN-"$i"---------------------------------------------------------------">>$path/results_hive_druid_$1.txt
 	{ time beeline -u "jdbc:hive2://$host:$port/;serviceDiscoveryMode=zooKeeper;zooKeeperNamespace=hiveserver2-hive2" -e "\"$q4_1\""; } &>> $path/results_hive_druid_$1.txt
	echo "-------------------------------------------FIM-RUN-"$i"------------------------------------------------------------">>$path/results_hive_druid_$1.txt
...
echo 'QUERY4.1-DONE'
echo -e '\nQUERY4.2-STARTING'
echo -e "\n\n+++++++++++++++++++++++++++++++++++++++++ QUERY-4.2 ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++">>$path/results_hive_druid_$1.txt
...
do 
    ...
    echo "----------------------------------------------------------------------------------------------------------------">>$path/results_hive_druid_$1.txt
	echo "--------------------------------------------RUN-"$i"---------------------------------------------------------------">>$path/results_hive_druid_$1.txt
 	{ time beeline -u "jdbc:hive2://$host:$port/;serviceDiscoveryMode=zooKeeper;zooKeeperNamespace=hiveserver2-hive2" -e "\"$q4_2\""; } &>> $path/results_hive_druid_$1.txt
	echo "-------------------------------------------FIM-RUN-"$i"------------------------------------------------------------">>$path/results_hive_druid_$1.txt
...
echo 'QUERY4.2-DONE'
echo -e '\nQUERY4.3-STARTING'
echo -e "\n\n+++++++++++++++++++++++++++++++++++++++++ QUERY-4.3  ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++">>$path/results_hive_druid_$1.txt
...
do 
    ...
    echo "----------------------------------------------------------------------------------------------------------------">>$path/results_hive_druid_$1.txt
	echo "--------------------------------------------RUN-"$i"---------------------------------------------------------------">>$path/results_hive_druid_$1.txt
 	{ time beeline -u "jdbc:hive2://$host:$port/;serviceDiscoveryMode=zooKeeper;zooKeeperNamespace=hiveserver2-hive2" -e "\"$q4_3\""; } &>> $path/results_hive_druid_$1.txt
	echo "-------------------------------------------FIM-RUN-"$i"------------------------------------------------------------">>$path/results_hive_druid_$1.txt
